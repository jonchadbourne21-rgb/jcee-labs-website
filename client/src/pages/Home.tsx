        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                At Jcee Labs, we don't build software the old way. We orchestrate advanced autonomous AI agents (like Manus) to streamline our research, code generation, and deployment pipelines — giving us an unfair advantage and letting us build faster.
              </p>
