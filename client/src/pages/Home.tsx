        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link href="/bidindustrial">
                    <a className="hover:text-teal-300 transition-colors">
                      BidIndustrial
                    </a>
                  </Link>
                </li>
                <li>
                  <Link href="/nicheflo">
                    <a className="hover:text-indigo-300 transition-colors">
                      NicheFlow
                    </a>
                  </Link>
                </li>
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <span className="cursor-default">HOWM HOLDINGS LLC</span>
                </li>
                <li>
                  <span className="text-white/40 text-xs">d.b.a: Jcee Labs</span>
                </li>
              </ul>
            </div>
          </div>
