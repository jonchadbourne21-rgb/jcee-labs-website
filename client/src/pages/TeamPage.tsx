        ...
        <div className="container max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 md:p-10 hover:border-purple-500/20 transition-colors">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white text-3xl font-display font-bold shrink-0 shadow-lg shadow-purple-500/20">
                JC
              </div>
