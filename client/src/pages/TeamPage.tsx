  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#080c18] via-[#0a1020] to-[#080c18] text-[#e8ecf4] flex flex-col">
      ...
      <section className="relative pt-32 pb-16 px-4">
        <div className="container max-w-[1100px] mx-auto text-center space-y-6">
      ...
      <section className="py-16 px-4">
        <div className="container max-w-[1100px] mx-auto space-y-12">
          ...
          <div className="bg-[#0d1424] border border-[#2a3a5a]/50 rounded-3xl p-8 md:p-10 hover:border-[#8ba4d8]/30 transition-colors">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  VOW wasn't born in a research lab. It was born from watching AI systems fail, lie, and leave no trace, then hearing the industry say "that's just how AI works." Jonathan asked a question most engineers never ask: <em className="text-[#c0c8d8]">What if the language itself could enforce accountability? What if every capability had to be declared, every run was dry by default, and every effect was traceable?</em>
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  He started building with no formal training, guided by a simple principle: <em className="text-[#c0c8d8]">"Anything is possible as long as you don't quit."</em> Manus was the tool. VOW was the vision. A language for agentic AI where every capability is declared in source, enforced at compile time, and compiles to readable Python. The dry runs, the structured traces, the persistent memory: these aren't academic concepts he borrowed. They're solutions he arrived at by thinking from fundamental principles, refusing to accept that small teams can't build what enterprises claim only they can.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  The result is 3 products built on VOW that prove formally-verified AI doesn't require a Fortune 500 budget. TrueRPM serves owner-operators because Jonathan believes the people who keep the economy moving deserve the same technological advantages as the people who profit from it. Every product is built for the underdog.
                </p>
                <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-16 px-4 border-t border-[#2a3a5a]/50">
        <div className="container max-w-[1100px] mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 bg-white/[0.02] border border-[#2a3a5a]/50 rounded-xl p-4 hover:border-[#8ba4d8]/30 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-white/40 mt-1">3 products, one language, no VC runway — built from fundamental principles by a team that refuses to accept "impossible."</p>
              </div>
            </div>
            <div className="flex items-start gap-3 bg-white/[0.02] border border-[#2a3a5a]/50 rounded-xl p-4 hover:border-[#8ba4d8]/30 transition-colors">
              <span className="text-[#8ba4d8] mt-1">•</span>
