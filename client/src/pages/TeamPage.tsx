          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 bg-white/[0.02] border border-[#2a3a5a]/50 rounded-xl p-4 hover:border-[#8ba4d8]/30 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-white/40 mt-1">Eight products, one language, no VC runway — built from fundamental principles by a team that refuses to accept "impossible."</p>
              </div>
            </div>
            <div className="flex items-start gap-3 bg-white/[0.02] border border-[#2a3a5a]/50 rounded-xl p-4 hover:border-[#8ba4d8]/30 transition-colors">
              <span className="text-[#8ba4d8] mt-1">•</span>
