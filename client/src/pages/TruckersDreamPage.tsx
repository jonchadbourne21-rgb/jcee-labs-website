  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#090514] via-[#0f0a1a] to-[#090514]">
      ...
      <section className="relative py-20 px-4">
        <div className="container max-w-4xl mx-auto">
          <div className="mb-6 inline-block px-4 py-2 rounded-full border border-orange-500/30 bg-orange-500/5">
            <span className="text-sm text-orange-400">Owner-Operator Load Optimization</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Link href="/">
              <a className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-orange-500/50 transition">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute bottom-20 left-1/4 w-96 h-96 bg-red-500/20 rounded-full blur-[120px] opacity-20 will-change-transform" />
        </div>
      </section>
      ...
      <section className="py-16 px-4 border-t border-white/10">
        <div className="container max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-12">Why Owner-Operators Choose Trucker$Dream</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition">
              ...
              <h3 className="text-lg font-semibold mb-2">Revenue Maximization</h3>
              <p className="text-gray-400">Intelligent load stacking algorithms that maximize revenue per mile while minimizing empty miles.</p>
            </div>

            <div className="p-6 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition">
              <MapPin className="w-8 h-8 text-orange-400 mb-4" />
              <h3 className="text-lg font-semibold mb-2">Route Optimization</h3>
              <p className="text-gray-400">Real-time route planning that accounts for fuel costs, delivery windows, and load compatibility.</p>
            </div>

            <div className="p-6 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition">
              <Truck className="w-8 h-8 text-orange-400 mb-4" />
              <h3 className="text-lg font-semibold mb-2">Multi-Stacking</h3>
              <p className="text-gray-400">Stack multiple loads efficiently to increase earnings and reduce operational costs per delivery.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 border-t border-white/10">
        <div className="container max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Grow Your Trucking Business</h2>
          <p className="text-gray-400 mb-8">Join owner-operators who are earning more with smarter load optimization.</p>
          <Link href="/">
            <a className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-orange-500/50 transition">
