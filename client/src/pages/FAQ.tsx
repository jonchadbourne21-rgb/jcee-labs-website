...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Products are at various stages. Some are in beta (VOW, NicheFlo, FloCraft, Baus Time Media, SOPForge), some are actively building (Mirrored, TrueRPM, Bourne Aire Industries), and Babodie is in beta with a waitlist. You can reach out to jonathan@jceelabs.com for early access or partnership inquiries.",
  },
  {
    value: "item-7",
