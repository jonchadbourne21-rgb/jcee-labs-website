...
const FAQ_ITEMS = [
  {
    ...
    answer: "Jcee Labs is an AI product studio and the registered d.b.a. of HOWM HOLDINGS LLC, founded in March 2026. We build formally-verified AI systems on VOW, our proprietary programming language where every agent action is provably safe and leaves a causal trail. One studio, one language, eight products.",
  },
  {
    value: "item-2",
  ...
  },
  {
    ...
    answer: (
      <>
        We currently have eight products: <strong>VOW</strong> (our programming language), <strong>Mirrored</strong> (AI higher self / personal development), <strong>TrueRPM</strong> (Revenue Per Mile for owner-operators), <strong>NicheFlo</strong> (GPU arbitrage &amp; DeFi yield optimization), <strong>FloCraft</strong> (supply chain intelligence), <strong>Bourne Aire Industries</strong> (industrial equipment bid management for HVAC), <strong>SOPForge</strong> (autonomous SOP platform), and <strong>Babodie</strong> (autonomous Neuro-OS).
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: "Products are at various stages. Some are in beta (VOW, NicheFlo, FloCraft, SOPForge), some are actively building (Mirrored, TrueRPM, Bourne Aire Industries), and Babodie is in beta with a waitlist. You can reach out to jonathan@jceelabs.com for early access or partnership inquiries.",
  },
  {
    value: "item-7",
    ...
    answer: (
      <>
        Jcee Labs was founded by <strong>Jonathan Chadbourne</strong>, a first-principles thinker who built VOW and all eight products without a CS degree. The studio proves that formally-verified AI doesn't need Fortune 500 budgets. George Taylor serves as advisor.
      </>
    ),
  },
  {
