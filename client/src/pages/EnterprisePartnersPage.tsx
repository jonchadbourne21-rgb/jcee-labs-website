...
export default function EnterprisePartnersPage() {
  useEffect(() => {
    ...
    document.title = "Consequential Workflow Assessment — JCEE Labs";
    return () => {
  ...
  return (
    <main className="program-page partner-page partner-path-page enterprise-partner-page" id="top">
      ...
      <section id="page-content" tabIndex={-1} className="program-masthead partner-masthead enterprise-partner-masthead">
        <p className="eyebrow"><span /> CONSEQUENTIAL WORKFLOW ASSESSMENT</p>
        <div className="program-number">JCEE LABS / ENTERPRISE ASSURANCE</div>
        <h1>
          One workflow.<br />
          <em>A clearer decision.</em>
        </h1>
        <p className="program-deck">
          Start with a bounded review of one consequential AI or automated workflow.
          Establish its evidence and authority boundaries, examine failure and recovery
          paths, and identify the smallest useful control improvement.
        </p>
        <div className="program-status-row">
          <span>SCOPE · AGREED BEFORE WORK BEGINS</span>
          <span>OUTCOME · BOUNDED REPORT, NOT CERTIFICATION</span>
        </div>
        <div className="program-links">
          <a href="#enterprise-inquiry-title">DISCUSS AN ASSESSMENT <span>→</span></a>
          <a href="/assurance">EXPLORE THE METHOD <span>→</span></a>
        </div>
      </section>
      ...
      <section className="partner-engagement-model" aria-labelledby="enterprise-engagement-title">
        <div className="section-index light">
          <span>02 / ASSESSMENT DELIVERABLES</span>
          <span>SMALLEST USEFUL BOUNDARY FIRST</span>
        </div>
        <div className="partner-shared-layout">
          <div>
            <p className="partner-kicker">WHAT YOU RECEIVE</p>
            <h2 id="enterprise-engagement-title">A report your team can act on.</h2>
            <p>
              Agree the workflow, access, tests, deliverables, fee, and delivery
              schedule before work starts. Production changes and implementation
              are separately scoped and authorized.
            </p>
          </div>
          <ol className="partner-sequence">
            <li><span>01</span><strong>Assurance Boundary Report</strong><p>State the claim, authority sources, examined conditions, supported conclusions, and unknowns.</p></li>
            <li><span>02</span><strong>Failure Map</strong><p>Map interrupted work, stale approval, duplicate effects, missing observations, and recovery decisions.</p></li>
            <li><span>03</span><strong>Evidence Architecture</strong><p>Identify the observations, versions, and review records needed to reconstruct the workflow.</p></li>
            <li><span>04</span><strong>Prioritized Control Plan</strong><p>Recommend the next useful test or control, including where existing native controls are sufficient.</p></li>
          </ol>
        </div>
      </section>
      ...
      <section className="partner-inquiry" aria-labelledby="enterprise-inquiry-title">
        ...
        <div className="partner-inquiry-layout">
          <div className="partner-inquiry-copy">
            <p className="partner-kicker">START WITH THE WORKFLOW</p>
            ...
            <p>
              Use a non-confidential summary. Do not include credentials,
              personal customer records, payment details, or private source code.
              Agree a secure exchange separately when necessary.
            </p>
            <dl>
              <div><dt>ROUTE</dt><dd>Enterprise assurance inquiry</dd></div>
              <div><dt>FIRST STEP</dt><dd>Scope and fit discussion</dd></div>
          ...
          <form className="partner-form enterprise-partner-form" onSubmit={openInquiryDraft}>
            <div className="partner-form-route">ENTERPRISE / ASSESSMENT INQUIRY</div>
            ...
            <div className="partner-form-submit">
              <button type="submit">OPEN ASSESSMENT DRAFT <span aria-hidden="true">→</span></button>
